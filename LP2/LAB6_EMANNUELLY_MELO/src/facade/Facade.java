 ...
 * 
 * @author Aluno de outro período // Emannuelly Larissa Freitas de Melo - Matrícula: 119210167.
 *
 */
public class Facade {
	...
	public void editaCombo(String combo, String descricaoCombo, String fornecedor, double novoFator) {
		this.cc.editaCombo(combo, descricaoCombo, fornecedor, novoFator);
	}
